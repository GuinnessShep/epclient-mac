...
#ifndef COM_SKYHIGHSECURITY_EPCLIENT_NETWORKEXTENSION_SWIFT_H
#define COM_SKYHIGHSECURITY_EPCLIENT_NETWORKEXTENSION_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="com_skyhighsecurity_epclient_networkextension",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

@class NSObject;

SWIFT_CLASS("_TtC45com_skyhighsecurity_epclient_networkextension20PacketTunnelProvider")
